...
module.exports = function() {
    ...
    var constants = {
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './node_modules/font-awesome/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        serve: {
            ...
            localtunnel: false, // true, false or 'poketracker'
            ghostMode: {
                clicks: false,
                forms: false,
                scroll: false
